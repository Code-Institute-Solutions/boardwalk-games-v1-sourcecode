...
- The boardgame library page utilises the Bootstrap grid and card components for consistency in layout and responsiveness.
...
## User Story 6: Visible pricing for events and student discount (should-have)
...
## User Story 7: Form to reserve a board game on Game Library page (should-have)
